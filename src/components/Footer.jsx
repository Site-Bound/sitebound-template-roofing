...
const AREAS = ['[COVERAGE TOWN 1]', '[COVERAGE TOWN 2]', '[COVERAGE TOWN 3]', '[COVERAGE TOWN 4]', '[COVERAGE TOWN 5]', '[COVERAGE TOWN 6]', '[COVERAGE TOWN 7]', '[COVERAGE TOWN 8]', '[COVERAGE TOWN 9]', '[COVERAGE TOWN 10]']
      ...
      <div style={{ maxWidth: '1152px', margin: '0 auto', padding: '64px 24px 0' }}>
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '48px', paddingBottom: '56px', borderBottom: '1px solid rgba(255,255,255,0.06)' }}>
          ...
          <div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '14px' }}>
              <a href="tel:[PHONE]" style={{ display: 'flex', alignItems: 'center', gap: '10px', textDecoration: 'none', color: '#bfcfe8', transition: 'color 0.2s' }}
              ...
              >
                ...
                <span style={{ fontFamily: "'Big Shoulders Display',sans-serif", fontWeight: 700, fontSize: '15px', letterSpacing: '0.04em' }}>[PHONE]</span>
              </a>
              <a href="mailto:[EMAIL]" style={{ display: 'flex', alignItems: 'center', gap: '10px', textDecoration: 'none', color: '#6e8aaa', transition: 'color 0.2s' }}
                onMouseEnter={e => { e.currentTarget.style.color = '#bfcfe8' }}
                onMouseLeave={e => { e.currentTarget.style.color = '#6e8aaa' }}
              >
                <div style={{ width: '30px', height: '30px', border: '1px solid rgba(224,145,24,0.2)', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
                  <svg width="13" height="13" fill="none" stroke="#e09118" strokeWidth="1.8" viewBox="0 0 24 24">
                    <path strokeLinecap="round" d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/>
                    <path strokeLinecap="round" d="M22 6l-10 7L2 6"/>
                  </svg>
                </div>
                <span style={{ fontFamily: "'Lora',serif", fontSize: '12px' }}>[EMAIL]</span>
              </a>
            </div>
          </div>
        </div>
        ...
        <div style={{ padding: '20px 0', display: 'flex', flexWrap: 'wrap', gap: '12px', justifyContent: 'space-between', alignItems: 'center' }}>
          ...
          <p style={{ fontFamily: "'Lora',serif", fontSize: '12px', color: '#3d5268', fontStyle: 'italic' }}>
            Fully insured &middot; Free quotes &middot; [AREA]
          </p>
        </div>
      </div>
    </footer>
