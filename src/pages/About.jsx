        ...
        <div style={{ maxWidth: '1152px', margin: '0 auto', padding: '0 24px' }}>
          <div style={{ gap: '80px' }} className="grid grid-cols-1 lg:grid-cols-2">
            ...
            <div className="reveal-left">
              ...
              <h2 className="display" style={{ fontSize: 'clamp(32px,4vw,52px)', color: '#07101f', marginBottom: '28px' }}>Coverage<br />Across the<br />[AREA].</h2>
              <p style={{ fontFamily: "'Lora',serif", fontSize: '14px', lineHeight: 1.8, color: '#5a7080', marginBottom: '28px' }}>
                We cover a wide area across [AREA]. If you are not sure whether we work in your location, just give us a call — there is a good chance we do.
              </p>
