          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1.6fr 1fr', gap: '80px', alignItems: 'start' }} className="grid-cols-1 lg:grid-cols-2">
                ...
                <form onSubmit={submit} noValidate style={{ background: 'white', padding: '40px', borderTop: '4px solid #e09118' }}>
                  ...
                  <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '20px', marginBottom: '20px' }}>
                    <div>
                      ...
                      <input name="phone" value={form.phone} onChange={change} placeholder="[PHONE]" type="tel" className={`form-input${errors.contact ? ' error' : ''}`} />
                    </div>
                    <div>
            ...
            <div className="reveal" style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
              ...
              <div style={{ background: 'white', padding: '24px', borderLeft: '4px solid #e09118' }}>
                <div style={{ fontFamily: "'Big Shoulders Display',sans-serif", fontWeight: 700, fontSize: '10px', letterSpacing: '0.16em', textTransform: 'uppercase', color: '#e09118', marginBottom: '10px' }}>Email</div>
                <a href="mailto:[EMAIL]" style={{ fontFamily: "'Lora',serif", fontSize: '13px', color: '#5a7080', textDecoration: 'none', wordBreak: 'break-all', transition: 'color 0.2s' }}
                  onMouseEnter={e => e.target.style.color = '#07101f'}
              ...
              <div style={{ background: 'white', padding: '24px', borderLeft: '4px solid #e09118' }}>
                ...
                <p style={{ fontFamily: "'Lora',serif", fontSize: '13px', lineHeight: 1.7, color: '#5a7080' }}>
                  We cover [COVERAGE TOWN 1], [COVERAGE TOWN 2], [COVERAGE TOWN 3], [COVERAGE TOWN 4], and all surrounding towns and villages across the [AREA].
                </p>
              </div>
              ...
              <div style={{ background: '#fff5e6', padding: '24px', border: '1px solid rgba(224,145,24,0.2)', borderLeft: '4px solid #e09118' }}>
                ...
                <p style={{ fontFamily: "'Lora',serif", fontSize: '13px', lineHeight: 1.7, color: '#7a5a20' }}>
                  For storm damage or active leaks, call <strong>[PHONE]</strong> directly. We offer same-day emergency response across the [AREA] where possible.
                </p>
              </div>
